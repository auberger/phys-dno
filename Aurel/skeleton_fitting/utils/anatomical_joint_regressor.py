...
class SparseSMPLtoAnatomicalRegressor:
    def __init__(self, output_dir="output/regressor", gender="male"):
    ...
    def generate_data(self, num_samples=10000):
        ...
        print(f"SKEL uses {num_pose_params} pose parameters")
    ...
    @staticmethod
    def predict_anatomical_joints(smpl_joints_file, regressor_path, gender="male", output_file=None, trial=0):
        """
